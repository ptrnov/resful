...
use api\modules\transaksi\models\TransPenjualanHeaderSummaryDaily;
use api\modules\transaksi\models\TransPenjualanHeaderSummaryDailySearch;

class TransRptTransController extends ActiveController
{

	public $modelClass = 'api\modules\transaksi\models\TransPenjualanHeaderSummaryDaily';
        ...
        return [
            'index' => [
                ...
                'prepareDataProvider' => function () {					
					$param=["TransPenjualanHeaderSummaryDailySearch"=>Yii::$app->request->queryParams];
					//return $param;
