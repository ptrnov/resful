...
/**
  ...
  * @since 		: 1.2
  * Subject		: ALL PROVINSI
  * Metode		: POST (Views)
  * URL			: http://production.kontrolgampang.com/master/provinsis
  * Body Param	: No Field.
 */
...
{	
    ...
    {        
		...
		//Model
		$modelProvinsi= Provinsi::find()->orderBy(['PROVINCE'=>SORT_ASC])->all();			
		return array('PROVINSI'=>$modelProvinsi);
	}	
}
