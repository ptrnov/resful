...
/**
  ...
  * @since 		: 1.2
  * Subject		: ALL PRODUCT PER-STORE
  * Metode		: POST (View)
  * URL			: http://production.kontrolgampang.com/master/product-stores
  * Body Param	: STORE_ID(Key)
 */
class ProductStoreController extends ActiveController
{	
    ...
    {        
		...
		if($modelCnt){			
			return array('LIST_PRODUCTS'=>$model);
		}else{
