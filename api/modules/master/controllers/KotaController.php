...
use api\modules\master\models\Kota;

/**
  * @author 	: ptrnov  <piter@lukison.com>
  * @since 		: 1.2
  * Subject		: ALL CITY FROM PROVINSI
  * Metode		: POST (Views)
  * URL			: http://production.kontrolgampang.com/master/kotas
  * Body Param	: PROVINCE_ID(key).
 */
class KotaController extends ActiveController
{	

    public $modelClass = 'api\modules\master\models\Kota';
    ...
    {        
		...
		//Model
		$modelKota= Kota::find()->orderBy(['CITY_ID'=>SORT_ASC])->Where(['PROVINCE_ID'=>$provinsiID])->all();			
		return array('KOTA'=>$modelKota);
	}	
}
