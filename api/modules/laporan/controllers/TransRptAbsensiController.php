...
use api\modules\laporan\models\AbsensiSearch;

class TransRptAbsensiController extends ActiveController
{

	public $modelClass = 'api\modules\laporan\models\AbsensiSearch';
        ...
        return [
            'index' => [
                ...
                'prepareDataProvider' => function () {					
					$param=["AbsensiSearch"=>Yii::$app->request->queryParams];
					//return $param;
