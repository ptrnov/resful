...
use api\modules\laporan\models\TransPenjualanDetailSummaryDailySearch;

class TransRpt2Controller extends ActiveController
{

	public $modelClass = 'api\modules\laporan\models\TransPenjualanDetailSummaryDaily';
        ...
        return [
            'index' => [
                ...
                'prepareDataProvider' => function () {					
					$param=["TransPenjualanDetailSummaryDailySearch"=>Yii::$app->request->queryParams];
					//return $param;
                    $searchModel = new TransPenjualanDetailSummaryDailySearch();
