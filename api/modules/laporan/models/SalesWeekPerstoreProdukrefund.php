...
class SalesWeekPerstoreProdukrefund extends DynamicModel
{
	...
	public function salesBulananProdukStore(){
		...
		//foreach($modelStore as $rowStore => $valStore){
			$sql="
				...
				ORDER BY a1.REFUND_SUBTTL_QTY DESC
			";					
	...
	private function chartlabel(){
		...
		$chart=[
			...
			"subCaption"=> $varTahun."-".$nmBulan."-w10",
			"captionFontSize"=> "12",
			...
			//== Exprort Chart ==
			"exportEnabled"=>"1",
			"exportFileName"=>"RINGKASAN-PRODUK-MINGGUAN",
