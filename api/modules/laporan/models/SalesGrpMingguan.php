...
class SalesGrpMingguan extends DynamicModel
{
	...
	private function chartData(){		
		...
		$datasetRslt=[];
			$sql="
				...
				FROM ptr_kasir_td3b
				WHERE ACCESS_GROUP='".$varAccessGroup."' AND TAHUN='".$this->TAHUN."' AND BULAN='".$this->BULAN."'
				GROUP BY ACCESS_GROUP,BULAN,MINGGU; 	
			";		
			...
			if ($modelWeekOfMonth){	
					...
					$rslt1['seriesname']=$nmBulan.'-w'.$modelWeekOfMonth[0]['MINGGU'];
					$dataval1=[];
					//=[3]==LOOPING 5 MINGGU
					//$x=1;
					//$cariWeek=0;
